  ...
  <div class='container'>
    ...
    <nav class='nav-menu-wrapper'>
      <div class='nav-menu-content'>
        ...
        <div class='buttons-wrapper'>
          <div class='button'>
            <div class='active' @click='goToAppointment()'><img
              src='~/assets/images/calendar-regular.svg'> Appointments
            </div>
          </div>
          <div v-if="userInfo.role === 'manager'" class='button'>
            <div class='active' @click='openAppointmentsModal()'><img
              src='~/assets/images/calendar-regular.svg'> Edit Appointments
            </div>
          </div>
          <div v-if="userInfo.role === 'manager'" class='button'>
            <div class='active' @click='openEmployeeModal()'><img
        ...
        <div class='extras'>
          <p>{{ userInfo.name }}</p>
          <div v-if='userInfo.name' class='cursor-pointer' @click='logout()'><img
            src='~/assets/images/door-open-solid.svg'></div>
