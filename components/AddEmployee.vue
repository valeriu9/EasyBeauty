    ...
    async save () {
      ...
      try {
        if (this.employeeToEdit.name) {
          await this.$axios.put(`http://easybeauty.somee.com/v1/api/Employee?id=${this.id}&cookie=${this.cookie} `, {
            name: this.name,
          ...
          await this.$axios.post(`http://easybeauty.somee.com/v1/api/Employee?id=${this.id}&cookie=${this.cookie}`, {
            name: this.name,
            phoneNr: this.phoneNr,
            email: this.email,
            role: this.role
